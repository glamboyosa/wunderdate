...
@TypeGraphQL.InputType("UsersOnApplicationUpdateManyWithWhereWithoutApplicationInput", {
  isAbstract: true
})
export class UsersOnApplicationUpdateManyWithWhereWithoutApplicationInput {
