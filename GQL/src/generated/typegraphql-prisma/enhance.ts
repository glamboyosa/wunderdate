...
const modelsInfo = {
  ...
  Application: ["id", "message", "status", "createdAt", "updatedAt"],
  Position: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
...
const outputsInfo = {
  ...
  ApplicationGroupBy: ["id", "message", "status", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  AggregatePosition: ["_count", "_avg", "_sum", "_min", "_max"],
  PositionGroupBy: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  ApplicationCount: ["role", "comments", "users"],
  ApplicationCountAggregate: ["id", "message", "status", "createdAt", "updatedAt", "_all"],
  ApplicationAvgAggregate: ["id"],
  ApplicationSumAggregate: ["id"],
  ApplicationMinAggregate: ["id", "message", "status", "createdAt", "updatedAt"],
  ApplicationMaxAggregate: ["id", "message", "status", "createdAt", "updatedAt"],
  PositionCountAggregate: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt", "_all"],
  PositionAvgAggregate: ["id", "applicationId"],
  PositionSumAggregate: ["id", "applicationId"],
  PositionMinAggregate: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
  PositionMaxAggregate: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
...
const inputsInfo = {
  ...
  ApplicationWhereInput: ["AND", "OR", "NOT", "id", "role", "message", "status", "comments", "users", "createdAt", "updatedAt"],
  ApplicationOrderByWithRelationInput: ["id", "role", "message", "status", "comments", "users", "createdAt", "updatedAt"],
  ApplicationWhereUniqueInput: ["id"],
  ApplicationOrderByWithAggregationInput: ["id", "message", "status", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  ApplicationScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "message", "status", "createdAt", "updatedAt"],
  PositionWhereInput: ["AND", "OR", "NOT", "id", "name", "description", "open", "application", "applicationId", "createdAt", "updatedAt"],
  PositionOrderByWithRelationInput: ["id", "name", "description", "open", "application", "applicationId", "createdAt", "updatedAt"],
  PositionWhereUniqueInput: ["id"],
  PositionOrderByWithAggregationInput: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  PositionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
  ...
  ApplicationCreateManyInput: ["id", "message", "status", "createdAt", "updatedAt"],
  ...
  PositionCreateManyInput: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
  ...
  ApplicationCountOrderByAggregateInput: ["id", "message", "status", "createdAt", "updatedAt"],
  ApplicationAvgOrderByAggregateInput: ["id"],
  ApplicationMaxOrderByAggregateInput: ["id", "message", "status", "createdAt", "updatedAt"],
  ApplicationMinOrderByAggregateInput: ["id", "message", "status", "createdAt", "updatedAt"],
  ApplicationSumOrderByAggregateInput: ["id"],
  ...
  PositionCountOrderByAggregateInput: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
  PositionAvgOrderByAggregateInput: ["id", "applicationId"],
  PositionMaxOrderByAggregateInput: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
  PositionMinOrderByAggregateInput: ["id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
  PositionSumOrderByAggregateInput: ["id", "applicationId"],
  ...
  PositionCreateNestedManyWithoutApplicationInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  PositionUpdateManyWithoutApplicationNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ApplicationCreateNestedOneWithoutRoleInput: ["create", "connectOrCreate", "connect"],
  BoolFieldUpdateOperationsInput: ["set"],
  ApplicationUpdateOneWithoutRoleNestedInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  ApplicationScalarWhereInput: ["AND", "OR", "NOT", "id", "message", "status", "createdAt", "updatedAt"],
  ...
  PositionCreateManyApplicationInputEnvelope: ["data", "skipDuplicates"],
  ...
  PositionUpsertWithWhereUniqueWithoutApplicationInput: ["where", "update", "create"],
  PositionUpdateWithWhereUniqueWithoutApplicationInput: ["where", "data"],
  PositionUpdateManyWithWhereWithoutApplicationInput: ["where", "data"],
  PositionScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "description", "open", "applicationId", "createdAt", "updatedAt"],
  ...
  ApplicationUpsertWithoutRoleInput: ["update", "create"],
  ...
  PositionCreateManyApplicationInput: ["id", "name", "description", "open", "createdAt", "updatedAt"],
